...
class CrmLead(models.Model):
    ...
    def action_send_msg(self):
        ...
        # Verifica se o modelo é crm.lead ou res.partner
        if self._name == 'crm.lead':
            return {'type': 'ir.actions.act_window',
                    ...
                    'view_mode': 'form',
                    'view_type': 'form',
                    'context': {'default_user_id': self.partner_id.id}}  # Para crm.lead
        else:
            return {'type': 'ir.actions.act_window',
                    'name': _('Whatsapp Message'),
                    'res_model': 'whatsapp.send.message',
                    ...
                    'view_mode': 'form',
                    'view_type': 'form',
                    'context': {'default_user_id': self.id}}  # Para res.partner
